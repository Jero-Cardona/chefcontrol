    ...
    <div class="contenedorRegistro">
        ...
        <div class="contenedorFormRegistro">
            <div class="contenedorFormRegistro1">
                ...
                <form action="{{route('cliente.update', $cliente[0]->Id_Cliente)}}" method="POST" class="formularioRegistro">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form1Registro">
                        <select value="{{$cliente[0]->Tipo_identificacion }}" id="Tipo_identificacion" name="Tipo_identificacion" required>
                    ...
                    <div class="form1Registro">
                        <select value="{{$cliente[0]->estado }}" id="estado" name="estado" required>
                            <option value="" disabled selected hidden>Tipo de Usuario {{$cliente[0]->estado }}</option>
