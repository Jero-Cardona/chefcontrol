                    ...
                    <form action="{{ route('cliente.store') }}" method="POST" class="formularioRegistro" id="form">
                        ...
                        <div class="form1Registro">
                            <select id="Tipo_identificacion" name="Tipo_identificacion"
                                ...
                                <option value="Cédula de Ciudadanía" @if (old('Tipo_identificacion') == 'Cédula de Ciudadanía') selected @endif>Cédula de
                                    Ciudadanía (CC)</option>
                                <option value="Tarjeta de Identidad" @if (old('Tipo_identificacion') == 'Tarjeta de Identidad') selected @endif>Tarjeta
                                    de Identidad (TI)</option>
                                <option value="Cédula de Extranjería " @if (old('Tipo_identificacion') == 'Cédula de Extranjería ') selected @endif>Cédula
