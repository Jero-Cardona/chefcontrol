...
<body>
    <header>
        <div class="div-index">
            ...
            <nav class="barra-index">
                <a class="a-index" href="">Inicio</a>
                <a class="a-index" href="">Contáctanos</a>
                <a class="a-index" href="">Registrarse</a>
                <a class="a-index" href="">Iniciar sesión</a>
            </nav>
        </div>
    </header>
    ...
    <div class="caja3">
        <div class=>
            <h2 class="tittle">Bienvenidos a nuestro sitio web</h2><br>
    ...
    <div class="caja5">
        <div>
            <img class="recetas" src="../../img/recetas.jpg" alt="">
        </div>
        <div>
    ...
    <footer class="footerIndex">
            <img class="logo1SenaIndex" src="../img/logoSena.png">
