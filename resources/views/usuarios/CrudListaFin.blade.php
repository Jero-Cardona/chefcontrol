...
<body class="bodyListas">
    <div class="contenedorListasR">
        ...
        <form class="buscador" style="display: inline-flex; float: end;" action="{{route('buscar.listas', ['buscar' => 2]) }}" method="GET">
                    ...
                    <div class="tablaResponsiveListaR">
                        <table class="tablaListaR">
                            <tbody>
                                ...
                                <p class="pListaR"><b>Lista realizada en la fecha:</b><br>{{ $fecha }}<br><b>Cocinero Responsable:</b><br>{{ $tareasCompletadas->first()->usuario->Nombre }}</p>
                                <div class="divButtonListaR">
                                    <a style="text-decoration: none; color: #fff;" href="{{route('vertareas', ['verlistas' => 2, 'fecha' => $fecha])  }}"><button class="buttonListaR">Ver detalles</button></a>
                                </div>
                            </tbody>
                        </table>
                    </div>
