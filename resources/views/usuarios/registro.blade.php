            ...
            <div class="contenedorFormRegistro1">
                ...
                <form action="{{route('usuarios.store')}}" method="POST" id="form" class="formularioRegistro">
                    ...
                    <div class="formRegistro">
                        <input type="text" id="Id_Empleado" name="Id_Empleado" value="{{ old('Id_Empleado') }}" required>
                    ...
                    <div class="form1Registro">
                        <select id="tipo_documento" name="tipo_documento" value="{{old('tipo_documento')}}" required>
                            ...
                            <option value="Cédula de Ciudadanía"  @if(old('tipo_documento') == 'Cédula de Ciudadanía') selected @endif>Cédula de Ciudadanía (CC)</option>
                            <option value="Tarjeta de Identidad" @if(old('tipo_documento') == 'Tarjeta de Identidad') selected @endif>Tarjeta de Identidad (TI)</option>
                            <option value="Cédula de Extranjería " @if(old('tipo_documento') == 'dula de Extranjería') selected @endif>Cédula de Extranjería (CE)</option>
                            <option value="NIT" @if(old('tipo_documento') == 'NIT') selected @endif>NIT (Número de Identificación Tributaria)</option>
                    ...
                    <div class="formRegistro">
                        <input id="password_confirmation" name="password_confirmation" type="password" value="{{old('password_confirmation')}}" required>
