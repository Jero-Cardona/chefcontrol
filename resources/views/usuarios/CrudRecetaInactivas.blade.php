    ...
    <div class="container">
        ...
        <div class="div1">
            <div class="div2">
                <div class="div3">
                    <div class="divHeader">
                        <h3 class="titulo">Lista de recetas inactivas</h3>
                        <a href="{{ route('recetas.pdf', ['button_id' => 2]) }}" class="btnEditar swal-pdfs"><b>Descargar PDF</b></a>
                        <form class="buscador" action="{{ route('buscar.recetas', ['buscar' => 2]) }}" method="GET">
                            @csrf
